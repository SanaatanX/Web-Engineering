<template>
  ...
  border-top-left-radius: 0px !important; // 弹框本身的顶部圆角
  border-top-right-radius: 7px !important;

  .el-dialog__header {
    background-color: #17223b !important; // **仅头部设置此深色背景**
    border-top-left-radius: 0px !important; // 与 .el-dialog 的顶部圆角保持一致
    border-top-right-radius: 0px !important; // 与 .el-dialog 的顶部圆角保持一致
  ...
  .el-dialog__headerbtn {
    ...
    top: 20px; // 对应 header 的 padding-top
