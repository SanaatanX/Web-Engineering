    ...
    >
      ...
      <el-form-item>
        <el-row style="width: 100%">
          ...
          >
            <el-button class="btn" type="primary" size="large" @click=""
              >登录</el-button
            >
          </el-col>
          <el-col
          ...
          >
            <el-button class="btn" type="danger" plain size="large" @click=""
              >重置</el-button
            >
          </el-col>
        </el-row>
...
import { tabsSotre } from "@/store/tabs";
const tstore = tabsSotre();
  ...
  loginRef.value?.validate(async (valid) => {
    if (valid) {
      ...
      if (res && res.code == 200) {
        ...
        tstore.setFatabs("home")
        tstore.setMineTabs("/mine/mycenter")
